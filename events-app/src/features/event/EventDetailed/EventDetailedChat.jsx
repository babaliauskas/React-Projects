...
class EventDetailedChat extends React.Component {
  state = {
    showReplyForm: false,
    selecetedCommentId: null
  };

  handleOpenReplyForm = id => () => {
    this.setState({
      showReplyForm: true,
      selecetedCommentId: id
    });
  };
  ...
  render() {
    ...
    const { showReplyForm, selecetedCommentId } = this.state;
    return (
      <div>
        <Segment
          textAlign="center"
                ...
                <Comment key={comment.id}>
                  ...
                  <Comment.Content>
                    ...
                    <Comment.Actions>
                      ...
                      {showReplyForm && selecetedCommentId === comment.id && (
